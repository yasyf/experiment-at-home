# experiment-at-home Style Guide

The concrete style rules for `athome/`. Target Python 3.13+.
...
if TYPE_CHECKING:
    from athome.models import Record
...
def model_version() -> str:
    from athome.state import RESOURCES
...
from athome.matcher import Matcher
from athome.runner import Runner

# Bad — redundant-alias / __all__ ceremony
from athome.matcher import Matcher as Matcher
